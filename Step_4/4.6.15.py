...
def crc_dict_list(p):
    if type(p) == list:
        print(p)
        if list(filter(int, p)) is True:
            return min(list(filter(int, p))) * min(list(filter(int, p)))
        else:
            return 0
    elif type(p) == dict:
        return sum(filter(int, p.keys))


if __name__ == '__main__':
    data = ['9', 83.1, 637, 907, 465, '785', 271.2, 223, 755, 29, 215, 5, 433, 897, 729, 645, 437, 427, 347, 237, 827,
            731,
            11, [139, 581], 473, 579, [483, 113, 923, 273, 615], 31.3, 63, 675, 787, 277, 441, 207, 819.5, 337, 641,
            239,
            27, 743, 703, '535', 117, 193, 515, 843, 887, 227, 485, 905, 655, 419, 209, [553, 933, 499], 185, 351,
            951.3,
            741, 115, 279, 33, 365, 205, 359, 289, 91, 19, 161, 81, 825, 263, '817', 739, 935, 413, 221, 501, 247,
            '775',
            ...
            (783, 639, 847, 927), 135, 257, 771, 311, 201, 303.5, 165, 127, 235, 141, (699, 959, 937, 947), 64.7, 649,
            411,
